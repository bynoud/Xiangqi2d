	...
	public struct GameConditions {
		...
		public GameConditions CalculateEndingConditions(Board resultingBoard, HalfMove lastHalfMove) {
			...
			return new GameConditions(
				...
				whiteCanCastleKingside: false, //WhiteCanCastleKingside && !whiteKingMoved && !whiteKingsideRookMoved,
				whiteCanCastleQueenside: false, //WhiteCanCastleKingside && !whiteKingMoved && !whiteQueensideRookMoved,
				blackCanCastleKingside: false, //BlackCanCastleKingside && !blackKingMoved && !blackKingsideRookMoved,
				blackCanCastleQueenside: false, //BlackCanCastleKingside && !blackKingMoved && !blackQueensideRookMoved,
				enPassantSquare: Square.Invalid, //GetNextEnPassantSquare(lastHalfMove),
				halfMoveClock: 0, //GetNextHalfMoveClock(lastHalfMove, HalfMoveClock),
